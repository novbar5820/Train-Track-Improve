...
export const EXERCISES: ExerciseDef[] = [
  ...
  { id: "seated-row-cable-wide-grip", name: "חתירה בכבל בישיבה אחיזה רחבה", muscleGroup: "back", equipment: "cable" },
  ...
  { id: "chest-supported-row-machine", name: "חתירה עם תמיכת חזה במכונה", muscleGroup: "back", equipment: "machine" },
  ...
  { id: "cable-lateral-raise", name: "הרחקת כתפיים בכבל", muscleGroup: "shoulders", equipment: "cable" },
  ...
  { id: "rear-delt-fly-dumbbell", name: "פרפר הפוך אחורי במשקולות", muscleGroup: "shoulders", equipment: "dumbbell" },
  { id: "cable-y-raise", name: "הרמת Y בכבל", muscleGroup: "shoulders", equipment: "cable" },
  ...
  { id: "shrug-barbell", name: "משיכת כתפיים במוט (שראגס)", muscleGroup: "shoulders", equipment: "barbell" },

  // יד קדמית - ביצפס
  { id: "bicep-curl-barbell", name: "כפיפת מרפקים במוט", muscleGroup: "biceps", equipment: "barbell" },
  { id: "ez-bar-curl", name: "כפיפת מרפקים במוט EZ", muscleGroup: "biceps", equipment: "barbell" },
  { id: "bicep-curl-dumbbell", name: "כפיפת מרפקים במשקולות", muscleGroup: "biceps", equipment: "dumbbell" },
  { id: "seated-curl-dumbbell", name: "כפיפת מרפקים בישיבה", muscleGroup: "biceps", equipment: "dumbbell" },
  { id: "incline-bench-curl-dumbbell", name: "כפיפת מרפקים בספסל שיפוע", muscleGroup: "biceps", equipment: "dumbbell" },
  ...
  { id: "rope-triceps-pushdown", name: "פשיטת מרפקים בכבל עם חבל", muscleGroup: "triceps", equipment: "cable" },
  ...
  { id: "overhead-triceps-extension-cable", name: "פשיטת מרפקים מעל הראש בכבל", muscleGroup: "triceps", equipment: "cable" },
  ...
  { id: "hack-squat", name: "האק סקוואט", muscleGroup: "legs", equipment: "machine" },
